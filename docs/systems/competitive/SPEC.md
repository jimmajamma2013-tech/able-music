...
**Date: 2026-03-16 | Updated: 2026-03-16 (live research pass)**
...
**IMPORTANT UPDATE (2026-03-16):**
Beacons revised their Store Pro to 0% take rate. The "5–30% revenue cut" argument is no longer fully accurate. The ABLE comparison table must be updated: Beacons Store Pro = 0% cut. Lower tiers may still have cuts — verify before citing specific percentages in any comparison.

**Funding confirmed: $29.8M from Y Combinator and Andreessen Horowitz.** Well-resourced and iterating.
Beacons has expanded from 3 tools to 14 tools. AI-powered email marketing (Email Marketing Pro, $13/mo) now built in.
...
### Laylo (formerly LayloFM)

**Context:**
Laylo is the most philosophically similar competitor to ABLE. It is explicitly built on artist-owned fan relationships, with direct fan communication as the core value proposition. As of 2025–2026 Laylo has expanded significantly beyond simple email/SMS into a multi-channel fan engagement suite.
...
- Direct fan messaging via SMS, email, and — as of 2025 — Instagram DMs
- **Instagram DM integration (new 2025):** converts Instagram post commenters into fan list entries; DMs them directly. Outside Lands achieved 140% CTR via this channel. A genuine new capability.
- **Laylo AI / "Clutch":** AI that analyses fan message drafts and suggests edits (add greeting, move link to end, tune urgency language) to maximise response rates
- **Notable Fans:** AI-surfaced fans with large social followings, for influencer-style outreach from inside the platform
- **Affiliates:** fans recruited as promoters, rewarded per conversion — the closest any competitor has come to a lightweight network effect
- Claims 10,000+ creators, $1B+ in facilitated revenue
- Has a US music industry audience including major-label-adjacent artists

**Pricing (confirmed 2025–2026):**
- Free: unlimited drops, 250 message credits
- Pro: $25/month ($300/year)
- SMS add-on: $10/month
- Messaging credits: $150 per 75,000

**Where the gaps are:**
- No campaign-aware profile states. Pre-release, live, and gig modes do not exist.
- No permanent visual profile identity. No design system. No music-culture aesthetic language.
- No gig mode. No real-time countdown.
- No freelancer discovery layer. No credits system.
- US-centric pricing and positioning (USD, US-market assumptions). ABLE is UK-first with international scope.
- The product is messaging infrastructure, not a public artist identity. ABLE is both.

**Primary switching trigger:**
The artist is already thinking about fan ownership (education barrier is lower) but finds Laylo's design limiting and its feature set too narrow when a release is happening. The profile is always the same regardless of where the artist is in their cycle.

**ABLE's counter:**
Design quality + campaign states + gig mode.

Laylo and ABLE agree on the most important thing: the fan relationship belongs to the artist. ABLE wins on execution breadth. The artist who moves from Laylo to ABLE is already converted — they just need a better tool.

**New threat signal:**
Laylo's Instagram DM channel is a genuine differentiator ABLE does not have. An artist who converts Instagram commenters directly into a Laylo fan list via DMs does not need a bio link for that traffic. ABLE's defence: all non-Instagram traffic (TikTok, YouTube, press, QR codes at shows) still requires a bio link destination. The DM channel is additive, not a bio link replacement.
...
| Linktree | 0 | 0 | 5 | 7 | 0 | 5 | 5 | 1 | 2 | 9 | **34** |
| Beacons | 0 | 3 | 5 | 7 | 0 | 6 | 6 | 5 | 3 | 8 | **43** |
| Feature.fm | 3 | 4 | 6 | 6 | 0 | 5 | 7 | 3 | 7 | 5 | **46** |
| Big Link (Linkfire) | 2 | 2 | 5 | 6 | 0 | 5 | 7 | 1 | 6 | 4 | **38** |
| Laylo | 2 | 8 | 7 | 6 | 0 | 7 | 5 | 9 | 3 | 7 | **54** |
...
| Winamp for Creators | 0 | 6 | 6 | 6 | 0 | 8 | 2 | 4 | 5 | 5 | **42** |
| EVEN | 0 | 5 | 7 | 6 | 0 | 4 | 5 | 6 | 7 | 4 | **44** |

**Score notes for 2026-03-16 update:**
- Linktree pricing revised down to 5 (price increase December 2025, domain flagged as spam)
- Beacons pricing revised up to 6 (Store Pro now 0% take rate confirmed)
- Laylo fan capture revised up to 9 (Instagram DM channel added — strongest fan capture of any competitor except ABLE); onboarding to 7 (more mature product); analytics to 5 (Laylo AI and Notable Fans added)
- Winamp for Creators and EVEN added as new entrants
...
- Pricing (5, revised down from 6): Price increase announced December 2025 with minimal notice ("sly notification"). The shared linktr.ee domain has been associated with phishing scams and social platforms have flagged it as spam — artists report Instagram Stories links being suppressed. The domain itself is now a liability.
- Music-native (2): Spotify and Apple Music link icons exist. No streaming embeds, no show listings, no release mechanics.
- New risk: Linktree's shared domain spam flagging is a concrete, urgent switching trigger ABLE can address. Artists whose links are being flagged are actively looking for alternatives with their own subdomain.
...
- Pricing (6, revised up from 4): Store Pro tier revised to 0% take rate. ABLE's previous "they take 5–30%" talking point is no longer accurate for Store Pro. Lower tiers may still have cuts. The comparison table on landing.html must be updated. ABLE's counter shifts to architecture: Beacons' 0% is a pricing decision; ABLE's 0% is the architecture.
- Funding: $29.8M from Y Combinator and Andreessen Horowitz — well-resourced, iterating fast.
- Onboarding (8): Good wizard experience. Visual editor is polished for someone who does not care about music-specific context.
- New capability: 14 tools (up from 3), AI email marketing built in at $13/mo.
...
**Laylo (updated 2026-03-16)**
- Fan ownership (8): The most credible competitor on this dimension. Ownership-first architecture is genuine, not marketing.
- Fan capture (9, revised up): Instagram DM integration is new and powerful — converts Instagram post commenters directly into fan list members. Artists who are Instagram-primary benefit significantly from this. ABLE does not have this capability yet.
...
- Analytics (5, revised up): Laylo AI (notable fans, AI message coaching) adds meaningful capability. Click and fan count still basic, but AI-surfaced super-fan identification is genuine new value.
- Onboarding (7, revised up): More mature product in 2025 — cleaner onboarding for the email + SMS + DM workflow.
- ABLE's counter: the architecture philosophy is shared. ABLE wins on execution above the email list — the visual identity, the live page states, the gig mode, the full release cycle. Laylo's DM capability is the one genuine gap ABLE should consider closing.
...
**Context:**
Winamp relaunched as a direct-to-fan platform for creators in 2026. The Winamp brand carries genuine nostalgia capital in the music-adjacent audience (the iconic 2000s media player). Their creator suite launched globally in early March 2026.

**What it does:**
- Website Builder: custom artist website
- Fanzone: subscription-based fan community with custom tiers and exclusive content
- Merchandising: integrated merch shop, claimed 0% platform cut
- First year free for artists who sign up March 15 – April 15, 2026; then €50/$55/year (~£42/year)

**What it does not do:**
- No campaign-aware page states
- No gig mode, no pre-release countdown
- No fan email capture in the bio-link sense — the Fanzone is a subscriber community, not a conversion mechanism for cold social traffic
- No freelancer credits system
- Website Builder positions them as a full-website tool, not a bio link optimisation

**ABLE's counter:**
Winamp is building the inner ring (committed fans who pay for access). ABLE is the outer ring that captures fans from cold traffic and converts them into the inner ring. These are complementary use cases, but an artist who chooses Winamp as their primary bio link will find it lacks campaign states entirely.

The free year offer will drive sign-ups. Artists who find the product limited after the free year (no campaign states, no profile that knows their release cycle) are ABLE prospects.

**Who stays on Winamp:** Artists who value the nostalgia brand and want a simple website + fan subscription in one product. Not actively competing for ABLE's core use case.

**Add to quarterly watch list:** Yes. Monitor if Winamp adds campaign-aware features or achieves significant scale via the free year.

---

### EVEN (superfan platform, UMG partnership)

**Context:**
EVEN is a direct-to-fan superfan platform that signed a multi-year deal with Universal Music Group in February 2026. It offers a consumer marketplace (EVEN Marketplace) and a white-label tool (EVEN Studio) that converts an artist's existing website into a superfan destination.

**What it does:**
- Early access music drops, exclusive content, direct fan purchase
- Physical music and merch fulfilment via UMG's global D2C infrastructure
- White-label deployment: artist website becomes a superfan destination
- Proven at scale: J. Cole's 2014 Forest Hills Drive 10th anniversary campaign used EVEN, returned album to Billboard Top 15

**What it does not do:**
- Not a bio-link tool — no cold traffic conversion mechanism
- No campaign states, no gig mode, no pre-release countdown
- Requires existing large audience — the target EVEN user has 100,000+ Spotify followers
- UMG-backed: fan data ultimately flows into UMG's systems. Not independent architecture.

**ABLE's counter:**
EVEN targets the label-adjacent artist with an existing large audience. ABLE targets the independent artist building their audience from scratch. These are different markets at current scale.

The philosophical distinction: EVEN is within the label system. An artist using EVEN is using UMG infrastructure. ABLE is explicitly independent. Artists who are wary of platform consolidation and label intermediation will prefer ABLE's architecture.

**Long-term signal:** UMG investing in direct-to-fan tools validates the entire category. If EVEN launches an independent (non-UMG) tier, the competitive landscape changes. Monitor.

---

### Bandcamp — ownership update

**Context:**
Bandcamp is now owned by Songtradr (acquired from Epic Games, October 2023). Approximately half of Bandcamp's original staff were laid off during the transition. The platform has stabilised but artist trust has been shaken.

**What changed in 2025–2026:**
- Desktop messaging launched — artists can now message fans by location and support level from desktop (was app-only)
- AI-generated music banned (January 2026) — Bandcamp explicitly positioning as human-artist platform
- Bandcamp Fridays extended: 8 per year in 2026
- Linkfire partnership for smart links into Bandcamp catalogue
- Direct-to-fan economics remain strong: artists keep up to 82% of sales

**ABLE's counter:**
Bandcamp's instability post-Songtradr creates artist anxiety about platform longevity. The email ownership argument is sharper: a Bandcamp-first artist who relies on Bandcamp's messaging system does not own those fan contact details — they belong to Bandcamp. If Songtradr faces further difficulties, the artist has nothing.

ABLE's RLS architecture and export-any-time positioning directly addresses this anxiety.
...
**Why it's on the watch list:**
Beacons is well-funded ($29.8M, Y Combinator + Andreessen Horowitz), growing, and continuously shipping features. Store Pro revised to 0% take rate. Their current design quality is below ABLE's but they have the resources to close that gap. Not a philosophical competitor — not music-first — but a capable, iterating link-in-bio tool.
...
- Whether the 0% store rate persists or is a promotional pricing decision
...
### Winamp for Creators — check every quarter (added 2026-03-16)

**Why it's on the watch list:**
Winamp launched a direct-to-fan suite (Website Builder, Fanzone, Merchandising) in March 2026 with a free-year offer running through April 2026. The nostalgia brand gives them organic reach in the music community. Their current product lacks campaign states entirely — but if the free year generates significant scale, they may invest in feature depth.

**What to check:**
- Whether the free year converts to active pages or just collects sign-ups
- Any announcement of campaign-state or pre-release features
- Pricing strategy after the free year ends

**What constitutes a material threat:**
Winamp ships a campaign-aware profile state system after achieving meaningful artist adoption via the free year. At €50/$55/year they would undercut ABLE on price for basic users.
