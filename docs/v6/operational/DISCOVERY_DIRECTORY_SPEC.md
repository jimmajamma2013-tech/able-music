...
```
ablemusic.co/artists              → directory home (browse by vibe)
ablemusic.co/artists/electronic   → vibe-filtered browse
ablemusic.co/artists/search?q=... → search results
ablemusic.co/artists/new          → recently joined (last 30 days)
ablemusic.co/artists/playing      → artists with upcoming shows (geo-aware)
```

---

## Directory home (`ablemusic.co/artists`)
...
## Vibe-filtered view (`ablemusic.co/artists/[vibe]`)
...
## Search (`ablemusic.co/artists/search`)
...
<meta name="description" content="[Bio first sentence]. Releases, shows, and fan sign-up at ablemusic.co/[handle]">
...
<meta property="og:url" content="https://ablemusic.co/[handle]">
...
- Endpoint: `ablemusic.co/og/[handle].png`

### Sitemap
- `ablemusic.co/sitemap.xml` — auto-generated, lists all public profiles
...
*The directory is ABLE's public face. Every artist page on the web links back to `ablemusic.co`. The directory should feel like flipping through a well-curated record shop — not browsing a streaming app. Quality over quantity. Restraint over maximalism.*
