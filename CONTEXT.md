...
- `docs/BUILD-READY-INDEX.md` — build agent orientation: order, P0 bugs, what to read per file (read before any build session)
- `docs/FULL-REVIEW-50.md` — 50-aspect review snapshot (2026-03-16, pre-sessions 11–14; some items now resolved — cross-reference STATUS.md)
- `docs/COMPETITIVE_INTELLIGENCE.md` — 11 competitor deep-dives with traffic, pricing, weaknesses
